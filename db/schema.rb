...
ActiveRecord::Schema[7.0].define(version: 2022_11_08_070247) do
  create_table "admin_companies", force: :cascade do |t|
    ...
    t.index ["email"], name: "index_admin_companies_on_email", unique: true
    t.index ["reset_password_token"], name: "index_admin_companies_on_reset_password_token", unique: true
  end
